...
t.eq('abcdefghijklmnopqrstuvwxyz123456aaa'.find('bd'), none)
...
t.eq('abcdefghijklmnopqrstuvwxyz123456789'.find('780'), none)
t.eq('abcdefghijklmnopqrstuvwxyz123456789'.find('mnopqrstuv'), 12)
t.eq('abcdefghijklmnopqrstuvwxyz123456789'.find('mnopqrstuw'), none)
...
t.eq('abcdefghijklmnopqrstuvwxyz123456'.findAnyRune('0'), none)
t.eq('abcdefghijklmnopqrstuvwxyz123456'.findAnyRune('07'), none)
...
t.eq('abcdefghijklmnopqrstuvwxyz123456789'.findAnyRune('0'), none)
