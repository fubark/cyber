...
t.eq(lib.testAdd(123.0, 321.0), 444.0)
t.eq(lib.testI8(-128.0), -128.0)
t.eq(lib.testU8(255.0), 255.0)
t.eq(lib.testI16(-32768.0), -32768.0)
t.eq(lib.testU16(65535.0), 65535.0)
t.eq(lib.testI32(-2147483648.0), -2147483648.0)
t.eq(lib.testU32(4294967295.0), 4294967295.0)
t.eq(lib.testI64(-123456789000.0), -123456789000.0)
t.eq(lib.testU64(123456789000.0), 123456789000.0)
t.eq(lib.testUSize(123456789000.0), 123456789000.0)
...
var res = lib.testObject(MyObject{ a: 123.0, b: 10.0, c: cstr, d: true})
t.eq(res.a, 123.0)
t.eq(res.b, 10.0)
...
cstr = os.cstr('foo')
var ptr = lib.testRetObjectPtr(MyObject{ a: 123.0, b: 10.0, c: cstr, d: true})
...
t.eq(testAdd(123.0, 321.0), 444.0)
...
t.eq(staticAdd(123.0, 321.0), 444.0)
