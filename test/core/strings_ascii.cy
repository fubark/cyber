...
t.eq(str.findAnyRune(.{`a`, `e`}).?, 0)
t.eq(str.findAnyRune(.{`e`, `a`}).?, 0)
t.assert(str.findAnyRune(.{`f`, `e`}) == none)
t.eq(str.findAnyRune(.{`c`, `d`}).?, 2)
t.eq(str.findAnyRune(.{`d`, `c`}).?, 2)
t.eq(str.findAnyRune(.{`c`, `d`, `i`}).?, 2)
...
t.eq('abcdefghijklmnopqrstuvwxyz123456'.findAnyRune(.{`6`, `m`}).?, 12)
t.assert('abcdefghijklmnopqrstuvwxyz123456'.findAnyRune(.{`0`}) == none)
t.assert('abcdefghijklmnopqrstuvwxyz123456'.findAnyRune(.{`0`, `7`}) == none)
t.eq('abcdefghijklmnopqrstuvwxyz123456'.findAnyRune(.{`0`, `7`, `m`}).?, 12)
...
t.eq('abcdefghijklmnopqrstuvwxyz123456789'.findAnyRune(.{`9`, `8`}).?, 33)
t.assert('abcdefghijklmnopqrstuvwxyz123456789'.findAnyRune(.{`0`}) == none)
t.eq('abcdefghijklmnopqrstuvwxyz123456789'.findAnyRune(.{`0`, `8`}).?, 33)
