...
for 0..clang.getNumDiagnostics(unit) -> i:
    ...
    dyn spelling = clang.getDiagnosticSpelling(diag)
...
clang.visitChildren(cursor, cvisitor.ptr(), cstate)
...
func getTranslationUnit(headerPath String) dyn:
    ...
    return clang.parseTranslationUnit(index, cpath, cargs, rest.len(), pointer.fromAddr(void, 0), 0,
...
func visitor(cursor clang.CXCursor, parent, client_data dyn) dyn:
...
func rootVisitor(cursor, parent, state dyn) dyn:
    ...
    case clang.CXCursor_StructDecl:
        ...
        clang.visitChildren(cursor, cvisitor.ptr(), cnewState)
    ...
    case clang.CXCursor_VarDecl:
        ...
        case clang.CXEval_UnExposed:
            ...
            case clang.CXCursor_CXXFunctionalCastExpr:
                ...
                var cstate = clang.ffi.bindObjPtr(state)
                clang.visitChildren(initCur, cvisitor.ptr(), cstate)
...
func toBindType(cxType dyn) dyn:
    ...
    case clang.CXType_Elaborated:
        ...
        dyn declType = clang.getCursorType(decl)
