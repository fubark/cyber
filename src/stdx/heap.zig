...
const WasmDefaultAllocator = struct {
    ...
    fn alloc(
        ...
        // log.tracev("alloc len={} align={} lalign={} => seg={}", .{len, alignment, len_align, seg_size});
    ...
    fn resize(
        ...
        // log.tracev("resize {} {} {} {}", .{@intFromPtr(buf.ptr), buf_align, new_len, len_align});
    ...
    fn free(
        ...
        if (seg_size <= 256) {
            ...
            // log.tracev("free small {} {} {}", .{@intFromPtr(buf.ptr), page_idx, frame_idx});
            ...
            // log.tracev("large free {} {} {} {}", .{@intFromPtr(buf.ptr), buf.len, page_idx, num_pages});
