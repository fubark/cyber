...
a = {1, 2, 3, 4, 5}
t.eq_span(a[1..4], {2, 3, 4})
-- Start index to end of slice.
t.eq_span(a[3..], {4, 5})
-- Start of slice to end index.
t.eq_span(a[0..3], {1, 2, 3})

--| Array of managed elements.
a2 := Array[^int]{^1, ^2, ^3}
a2_view := a2[0..1]
t.eq(1, a2_view[0].*)
...
-- insert() at end
a.insert(2, 3)
t.eq_span([&]int{2, 1, 3}, a[..])

-- insert() in middle
a.insert(1, 4)
t.eq_span([&]int{2, 4, 1, 3}, a[..])
